package com.excella.reactor.application.controllers.advice;
...
public class CrudControllerAdvice {
  ...
  private static GenericError buildGenericError(
      final String message, final HttpStatus httpStatus, final List<String> details) {
  ...
  private static String formatConstraintViolation(final ConstraintViolation violation) {
