...
public class SwaggerConfig {
  ...
  /**
   * Create instance with securityProperties and servletContext
   *
  ...
  private OAuth securitySchema() {
    final List<AuthorizationScope> authorizationScopeList = Arrays.asList(scopes);
    return new OAuth(
        "oauth2schema",
  ...
  /**
   * Builds a SecurityConfiguration object
   *
   * @return a SecurityConfiguration object
   */
  @Bean
